                            ...
                            <div class="page-title-box">
								...
								<div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active"><a href="blog-add.php">Add Blog</a></li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									//$blo_id = $_GET['id'];
									$sql = $db->query("select * from blog ORDER BY id DESC");
									$count = 0;
									if($sql->num_rows>0){
                                    while($row = $sql->fetch_assoc()){ ?>
                                        <tr>
											<td><?php echo ++$count;?></td>
                                            <td><a href="admin-blog-details.php?id=<?php echo $row['id'];?>" target="_blank"><?php echo $row['title'];?></a></td>
                                            <td><a href="admin-blog-details.php?id=<?php echo $row['id'];?>" target="_blank"><img src="blogs/<?php echo $row['cou_image'];?>" width="50%"></a></td>
                                            <td><?php echo $row['status'];?></td>
                                            <td><a href="blog-update.php?id=<?php echo $row['id'];?>" target="_blank"><i class="fas fa-edit"></i></a> / <a href="blog-delete.php?id=<?php echo $row['id'];?>"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
