...
<head>
    <meta charset="utf-8" />
    <title>Course Category Update</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Course category Update</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-lg-10">
                            <div class="card-box">
                                <div class="">
									...
									$cou_id = $_GET['id'];
									$sql = "select * from course_category where course_category_id='$cou_id'";
...
$category_name = $row["category_name"];
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="category_name" id="" value="<?php echo $category_name; ?>">
                                        </div>
                                        <div class="form-group mb-4">
...
if(isset($_POST["submit"])){ 
	...
	$category_name = mysqli_real_escape_string($db,$_POST['category_name']);
      $status  = mysqli_real_escape_string($db,$_POST['status']);
                ...
                $insert = $db->query("Update course_category set category_name = '".$category_name."',status = '".$status."', uploaded_on = NOW() WHERE course_category_id ='".$course_id."'"); 
                if($insert){ 
                    $statusMsg = "<br><div class='alert alert-success text-center' role='alert'><strong>".$category_name. "</strong> has been updated successfully.</div>"; 
                }else{ 
