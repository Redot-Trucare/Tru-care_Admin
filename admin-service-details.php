                        ...
                        <div class="col-lg-12">
                            <div class="row">
								<?php
									...
									$cou_id = $_GET['id'];
									$sql = "select * from services where id='$cou_id'";
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="card blog-post bg-transparent">
											 <div class="post-image">
												 <h5><b>Thumbnail Image</b></h5>
                                                <img src="services-thumbnail/<?php echo $th_image; ?>" alt="" class="img-fluid mx-auto d-block rounded-top">
                                                <br><br>
                                            </div>
                                             <h5><b>Service Page</b></h5>
                                            <div class="post-image">
                                                <img src="services/<?php echo $image; ?>" alt="" class="img-fluid mx-auto d-block rounded-top">
