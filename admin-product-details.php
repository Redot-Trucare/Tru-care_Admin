                        ...
                        <div class="col-lg-12">
                            <div class="row">
								<?php
									...
									$cou_id = $_GET['id'];
									$sql = "select * from products where id='$cou_id'";
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="card blog-post bg-transparent">
                                            <div class="post-image">
                                                <img src="products/<?php echo $image1; ?>" alt="" class="img-fluid mx-auto d-block rounded-top">
                                                <img src="products/<?php echo $image2; ?>" alt="" class="img-fluid mx-auto d-block rounded-top">
                                            </div>

                                            <div class="card-body">
                                                <!--<div class="text-muted"><span>by <a class="text-dark">John Doe</a>,</span> <span>Dec 10, 2018</span></div>-->
                                                <div class="post-title">
													<h5><b><?php echo $sku; ?></b></h5>
													<h5><b><?php echo $category; ?></b></h5>
                                                    <h5><b><?php echo $product_name; ?></b></h5>
                                                    <h6><b>₹ <?php echo $price; ?></b></h6>                                                    
                                                </div>
                                                <div>
