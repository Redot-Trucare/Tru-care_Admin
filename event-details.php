                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="card blog-post bg-transparent">
                                            <div class="post-image">
                                                <img src="events/<?php echo $event_image; ?>" alt="" class="img-fluid mx-auto d-block rounded-top">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="post-title">
                                                    ...
                                                    <h6><b>Event Date : </b><?php $date_str = $event_date;
                                	          $timestamp = strtotime($date_str);
                                	          $formatted_date = date('F d, Y', $timestamp);
                                	          echo $formatted_date; ?></h6>
                                                    <h6><b>Timing : </b><?php echo $timing; ?></h6>
                                                    <h6><b>Address : </b><?php echo $address; ?></h6>
                                                    <h6><b>Contact : </b><?php echo $contact; ?></h6>
                                                </div>
                                                <div>
