                            ...
                            <div class="page-title-box">
								...
								<div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active"><a href="product-category-add.php">Add Product Category</a></li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									//$blo_id = $_GET['id'];
									$sql = $db->query("select * from product_category");
									$count=0;
									if($sql->num_rows>0){
                                    while($row = $sql->fetch_assoc()){ ?>
                                        <tr>
                                            ...
                                            <td><a href="product-category-update.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit"></i></a> / <a href="product-category-delete.php?id=<?php echo $row['id'];?>"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
