                            ...
                            <div class="page-title-box">
								...
								<div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active"><a href="course-add.php">Add Course</a></li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									//$blo_id = $_GET['id'];
									$sql = $db->query("select * from courses ORDER BY id DESC");
									$count = 0;
									if($sql->num_rows>0){
                                    while($row = $sql->fetch_assoc()){ ?>
                                        <tr>
											<td><?php echo ++$count;?></td>
                                            <td><a href="admin-course-details.php?id=<?php echo $row['id'];?>" target="_blank"><?php echo $row['title'];?></a></td>
                                            <td><?php echo $row['sub_title'];?></td>
                                            <td><a href="admin-course-details.php?id=<?php echo $row['id'];?>" target="_blank"><img src="courses/<?php echo $row['cou_image'];?>" width="100%"></a></td> 
                                            <td><?php echo $row['status'];?></td>
                                            <td><a href="course-update.php?id=<?php echo $row['id'];?>" target="_blank"><i class="fas fa-edit"></i></a> / <a href="course-delete.php?id=<?php echo $row['id'];?>"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
