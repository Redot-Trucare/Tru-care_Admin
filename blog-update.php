                        ...
                        <div class="col-lg-10">
                            <div class="card-box">
                                <div class="">
									...
									$blo_id = $_GET['id'];
									$sql = "select * from blog where id='$blo_id'";
...
$meta = $row["meta"];
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="file" name="image_file" value="<?php echo $cou_image; ?>" class="form-control" data-height="210" />
                                            <br><img src="blogs/<?php echo $cou_image; ?>" width="50%" height="50%">
                                        </div>
                                        <div class="form-group mb-4">
      ...
      $query = $db->query("SELECT title FROM courses WHERE title='$title'");
        ...
        /*if($count == 1) { 
			  $statusMsg = "<br><div class='alert alert-danger mb-0 text-center' role='alert'><strong>Already Exists</strong></div>";
                ...
                $insert = $db->query("Update blog set title = '".$title."', sub_title = '".$sub_title."', description = '".$description."', meta_title = '".$meta_title."', meta_desc = '".$meta_description."', meta_link = '".$meta_link."', meta = '".$meta."',status = '".$status."', uploaded_on = NOW() WHERE id ='".$blog_id."'"); 
                if($insert){ 
    ...
    $ext = strtolower(pathinfo($name, PATHINFO_EXTENSION));
        ...
        if(in_array($ext, $permissible_extension)){
            if(move_uploaded_file($temp,"blogs/".$name)){
                $sql1 = $db->query("Update blog Set cou_image = '$name' Where id = '$blog_id'");
			}
		}
     }
} 
