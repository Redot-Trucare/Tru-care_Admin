                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Product category Update</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-lg-10">
                            <div class="card-box">
                                <div class="">
									...
									$cou_id = $_GET['id'];
									$sql = "select * from product_category where id='$cou_id'";
...
if(isset($_POST["submit"])){ 
	...
	$category_name = mysqli_real_escape_string($db,$_POST['category_name']);
      $status  = mysqli_real_escape_string($db,$_POST['status']);
                ...
                $insert = $db->query("Update product_category set category_name = '".$category_name."',status = '".$status."', uploaded_on = NOW() WHERE id ='".$course_id."'"); 
                if($insert){ 
