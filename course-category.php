                            ...
                            <div class="page-title-box">
								...
								<div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active"><a href="course-category-add.php">Add Course Category</a></li>
                                    </ol>
                                </div>
                                ...
                                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    while($row = $sql->fetch_assoc()){ ?>
                                        <tr>
                                            ...
                                            <td><a href="course-category-update.php?id=<?php echo $row['course_category_id'];?>"><i class="fas fa-edit"></i></a> / <a href="course-category-delete.php?id=<?php echo $row['course_category_id'];?>"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
