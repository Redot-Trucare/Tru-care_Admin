...
<head>
    <meta charset="utf-8" />
    <title>Course Category Add</title>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="course-category.php">Course Categories</a></li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Add Course Category</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
...
if(isset($_POST["submit"])){ 
	$category_name = mysqli_real_escape_string($db,$_POST['category_name']);
      ...
      $query = $db->query("SELECT category_name FROM course_category WHERE category_name = '$category_name'");
        ...
        if($count == 1) { 
			  $statusMsg = "<br><div class='alert alert-danger mb-0 text-center' role='alert'><strong>Already Exists</strong></div>";
                ...
                $insert = $db->query("INSERT INTO course_category (category_name, status, uploaded_on) VALUES ('".$category_name."','".$status."', NOW())"); 
                if($insert){ 
